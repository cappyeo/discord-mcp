...
export async function verifyRealBenchmarkArtifact({
  ...
  return {
    ...
    apply_result_loss_cases: recomputed.summary.apply_result_loss_cases,
    apply_result_loss_recoveries: recomputed.summary.apply_result_loss_recoveries,
    gate_passed: recomputed.summary.gate_passed,
    verified_correctness_gate_passed: recomputed.summary.verified_correctness_gate_passed,
