...
a single contract, use the [tool catalog](/discord-mcp/tools/).
...
<CardGrid>
  ...
  <Card title="Pipeline — chain three calls sequentially" icon="seti:cjsc">
  ...
  <Card title="Gateway — verify live notifications" icon="seti:bsl">
