...
- **Broad Discord surface** - discord-mcp covers 192 Discord tools, plus an
...
**discord-mcp**: Ships 193 tools and filters the advertised registry server-side
...
- [discord-mcp tools (193)](/discord-mcp/tools/)
