...
**discord-mcp**: Ships 201 tools and filters the advertised registry server-side
...
**discord-mcp**: `MCP_DRY_RUN=true` protects only the 30 tools registered with
...
- [discord-mcp tools (201)](/discord-mcp/tools/)
