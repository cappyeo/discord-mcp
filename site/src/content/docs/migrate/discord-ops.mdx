...
**discord-mcp**: Ships 208 tools and filters the advertised registry server-side
...
**discord-mcp**: `MCP_DRY_RUN=true` protects only the 31 tools registered with
...
- [discord-mcp tools (208)](/discord-mcp/tools/)
