...
- **Reference fixture**:
  [bundled Hubdustry snapshot](https://github.com/cappyeo/discord-mcp/tree/main/packages/mcp-server/test-fixtures/hubdustry-go-mcp/apps/mcp)
...
The bundled Hubdustry fixture models a Go MCP server for server administration:
file operations and deploy triggers. It lives in a different problem space
from discord-mcp entirely.
