...
- **Use `discord-mcp init`** to generate the discord-mcp client config:
  ...
  discord-mcp's 198 Discord tools (plus one optional inspiration tool) added
  next to Hubdustry's 8 system tools.
...
- [discord-mcp tools (202)](/discord-mcp/tools/) - what you get if you
