...
onto discord-mcp's 207-tool surface - with explicit confidence levels and
...
<DocsCardGrid
  links={[
    { title: 'PaSympa', href: '/discord-mcp/migrate/pasympa/', description: 'TypeScript, ~91 tools, discord_* prefix.' },
    { title: 'quadslab', href: '/discord-mcp/migrate/quadslab/', description: '@quadslab.io, ~138 tools, includes MCP Resources surface.' },
    { title: 'discord-ops', href: '/discord-mcp/migrate/discord-ops/', description: 'Multi-guild routing, dry-run mode, tool profiles, ~49 tools.' },
    { title: 'Hubdustry', href: '/discord-mcp/migrate/hubdustry/', description: 'Reference adapter (Go MCP, non-Discord) - framework smoke test.' },
  ]}
/>
...
3. **Generate your new client config.**
   ...
   Prints a platform-appropriate config snippet pointing at the freshly
   installed `discord-mcp` binary. Merge it into your MCP client configuration,
   set `DISCORD_TOKEN`, then restart the client.
...
- [discord-mcp tools (207)](/discord-mcp/tools/) - the auto-generated tool
