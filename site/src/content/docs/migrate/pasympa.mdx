---
title: From PaSympa
description: Migrate from PaSympa's discord_* tool surface (~91 tools) onto discord-mcp's 207-tool catalog.
sidebar:
  order: 1
---
...
- [discord-mcp tools (207)](/discord-mcp/tools/) - auto-generated reference.
