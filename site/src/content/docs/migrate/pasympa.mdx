---
title: From PaSympa
description: Migrate from PaSympa's discord_* tool surface (~91 tools) onto discord-mcp's 193-tool catalog.
sidebar:
  order: 1
---
...
- **Broad Discord surface** - 192 Discord tools cover stickers, automod, polls, application
...
5. **Generate your new client config.**
   ...
   The 192 Discord-operation tools replace PaSympa's 91; the separate
...
- [discord-mcp tools (193)](/discord-mcp/tools/) - auto-generated reference.
