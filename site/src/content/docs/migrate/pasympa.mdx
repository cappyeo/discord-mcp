---
title: From PaSympa
description: Migrate from PaSympa's discord_* tool surface (~91 tools) onto discord-mcp's 208-tool catalog.
sidebar:
  order: 1
---
...
- [discord-mcp tools (208)](/discord-mcp/tools/) - auto-generated reference.
