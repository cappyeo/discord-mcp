---
title: From quadslab
description: Migrate from @quadslab.io/discord-mcp's ~138-tool surface onto discord-mcp's 203-tool catalog.
sidebar:
  order: 2
---
...
- **Explicit confirmation on selected high-risk tools** - the 30 tools
