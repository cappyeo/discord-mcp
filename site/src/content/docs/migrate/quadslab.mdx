---
title: From quadslab
description: Migrate from @quadslab.io/discord-mcp's ~138-tool surface onto discord-mcp's 207-tool catalog.
sidebar:
  order: 2
---
...
6. **Optional - enable Gateway notifications.**
   ...
   Gateway events. It does not expose quadslab's live resources through
   `resources/list` or `resources/read`; retain the old resource path until
   the notification-plus-REST-read flow is verified in your client.
