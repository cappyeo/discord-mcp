---
title: From quadslab
description: Migrate from @quadslab.io/discord-mcp's ~138-tool surface onto discord-mcp's 193-tool catalog.
sidebar:
  order: 2
---
...
- **Explicit confirmation on selected high-risk tools** - the 29 tools
...
- **Templates (4)** - `list_templates`, `create_template`, `delete_template`,
  ...
  today. Workaround: continue calling the REST endpoint directly, or omit the
  feature.
