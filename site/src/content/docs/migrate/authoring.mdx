...
[`packages/mcp-server/src/lib/migrate-adapters/types.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/types.ts):
...
1. **Fork the repo and create a branch.**
   ...
   ```bash
   gh repo fork cappyeo/discord-mcp --clone
   cd discord-mcp
...
5. **Register in `ALL_ADAPTERS`.**
   ...
   Edit
   [`packages/mcp-server/src/lib/migrate-adapters/index.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/index.ts)
...
- [Migration overview](/discord-mcp/migrate/) - what migration means and the
  three-step CLI flow.
- [`MigrationSource` source](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/types.ts)
  - the canonical interface definition.
- Shipping adapters - read these for working patterns:
  - [`hubdustry-go-mcp.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/hubdustry-go-mcp.ts)
    - minimal reference (Go, empty NAME_MAP).
  - [`pasympa.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/pasympa.ts)
    - TypeScript with prefix-based extraction (Pattern A).
  - [`quadslab.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/quadslab.ts)
    - TypeScript with known-name intersection (Pattern B).
  - [`discord-ops.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-server/src/lib/migrate-adapters/discord-ops.ts)
