---
title: Sampling
description: How discord-mcp uses MCP sampling to call back into the client's LLM. The 5 intelligence tools — summarization, classification, entity extraction, moderation, reply drafting — the host_llm_should_process fallback, the prompt-injection defense.
sidebar:
  order: 8
---
...
summarization, classification, entity extraction, moderation, and reply
drafting — so the operator gets LLM-grade output without the server having
any LLM API key of its own.
...
| Tool | What it does |
| ---- | ------------ |
| `intelligence_summarize_channel` | Compress recent channel history into a paragraph. |
| `intelligence_classify_messages` | Multi-label classification of a message batch. |
| `intelligence_extract_entities` | Pull structured entities out of a message batch. |
| `intelligence_moderate_content` | Policy-aware moderation assessment of content. |
| `intelligence_draft_response` | Draft a context-aware reply for the operator to review. |
...
Source: [`packages/mcp-core/src/tools/intelligence/_lib/sampling.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-core/src/tools/intelligence/_lib/sampling.ts).
...
| Concern | File |
| ------- | ---- |
| Sampling helpers | [`tools/intelligence/_lib/sampling.ts`](https://github.com/cappyeo/discord-mcp/blob/main/packages/mcp-core/src/tools/intelligence/_lib/sampling.ts) |
| 5 tool definitions | [`tools/intelligence/`](https://github.com/cappyeo/discord-mcp/tree/main/packages/mcp-core/src/tools/intelligence) |
