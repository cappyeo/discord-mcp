...
- **Tool piece** implements one of the 204 tools, using Discord REST, MCP
...
- [Tools](/discord-mcp/tools/) - auto-generated reference for all 204 tools.
