...
- **Tool piece** implements one of the 193 tools, using Discord REST, MCP
...
- [Tools](/discord-mcp/tools/) - auto-generated reference for all 193 tools.
