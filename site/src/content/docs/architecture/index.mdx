...
- **Tool piece** implements one of the 207 tools, using Discord REST, MCP
...
- [Tools](/discord-mcp/tools/) - auto-generated reference for all 207 tools.
