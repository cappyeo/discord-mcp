...
- **Tool piece** implements one of the 201 tools, using Discord REST, MCP
...
- [Tools](/discord-mcp/tools/) - auto-generated reference for all 201 tools.
