...
- **Tool piece** implements one of the 202 tools, using Discord REST, MCP
...
- [Tools](/discord-mcp/tools/) - auto-generated reference for all 202 tools.
