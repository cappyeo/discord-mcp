---
title: Confirmation
description: The __confirm:true + MCP_DRY_RUN=false mechanical guard used by 29 explicitly registered high-risk tools, including its limits and client responsibilities.
sidebar:
  order: 7
---
...
precondition - **29 of the 193 tools**, listed
