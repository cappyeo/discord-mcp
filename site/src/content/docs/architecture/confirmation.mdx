---
title: Confirmation
description: The __confirm:true + MCP_DRY_RUN=false mechanical guard used by 31 explicitly registered high-risk tools, including its limits and client responsibilities.
sidebar:
  order: 7
---
...
precondition - **31 of the 208 tools**, listed
...
31 gated tools only**, after the zod → JSON Schema conversion:
...
The current source registry has exactly **31 tools** out of 208 - every irreversible
