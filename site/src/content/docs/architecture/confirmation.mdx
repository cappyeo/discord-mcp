...
precondition - **30 of the 201 tools**, listed
...
The current source registry has exactly **30 tools** out of 201 - every irreversible
...
- [Operations → Client capability matrix](/discord-mcp/operations/clients/) - what each client supports; the `__confirm` contract is universal.
