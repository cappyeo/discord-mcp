...
- [Architecture → Confirmation](/discord-mcp/architecture/confirmation/) - the exact payload-hash approval for `components_v2_send` / `_edit` / `_send_from_template`, alongside the legacy `__confirm` gate for destructive tools.
