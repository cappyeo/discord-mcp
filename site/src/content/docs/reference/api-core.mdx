...
`@discord-mcp/core/dist/tools/_lib/...` or any path other than the package
...
```ts
import { ChannelId, defineTool } from '@discord-mcp/core';
import { z } from 'zod';
...
[`MCP_CATEGORIES`](/discord-mcp/reference/config/access/#mcp_categories).
</Aside>
