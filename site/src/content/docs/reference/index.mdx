...
<DocsCardGrid
  links={[
    { title: 'CLI', href: '/discord-mcp/reference/cli/', description: 'serve, credential-free catalog discovery, setup/activity/update/profile lifecycle, doctor, smoke, init, and migrate.' },
    ...
    { title: 'Changelog', href: '/discord-mcp/reference/changelog/', description: 'One section per release v0.0.0 → v0.23.0, with dates and user-visible changes.' },
