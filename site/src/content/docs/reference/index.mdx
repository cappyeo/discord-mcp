...
runtime behavior, the public TypeScript exports from `@cappyeo/discord-mcp-core`, and a
...
<CardGrid>
  ...
  <LinkCard
    title="Changelog"
    description="One section per release v0.0.0 → v0.12.0. Highlights, dates, links to merge commits."
