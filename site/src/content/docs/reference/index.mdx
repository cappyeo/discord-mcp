...
<DocsCardGrid
  links={[
    { title: 'CLI', href: '/discord-mcp/reference/cli/', description: 'discord-mcp serve | doctor | init | migrate. All flags, exit codes, and example invocations.' },
    { title: 'Environment variables', href: '/discord-mcp/reference/config/', description: 'Exact runtime contract for all 28 variables, split into access, safety, runtime, observability, resilience, and audit.' },
    ...
    { title: 'Changelog', href: '/discord-mcp/reference/changelog/', description: 'One section per release v0.0.0 → v0.13.2, with dates and user-visible changes.' },
  ]}
/>
