...
<DocsCardGrid
  links={[
    { title: 'CLI', href: '/discord-mcp/reference/cli/', description: 'serve, setup/activity/profile lifecycle, doctor, smoke, init, and migrate. All flags, exit codes, and examples.' },
    ...
    { title: 'Changelog', href: '/discord-mcp/reference/changelog/', description: 'One section per release v0.0.0 → v0.14.6, with dates and user-visible changes.' },
