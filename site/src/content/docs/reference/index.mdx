...
<DocsCardGrid
  links={[
    ...
    { title: 'Environment variables', href: '/discord-mcp/reference/config/', description: 'Exact runtime contract for all 29 variables, split into access, safety, runtime, observability, resilience, and audit.' },
