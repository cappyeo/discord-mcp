...
<DocsCardGrid
  links={[
    ...
    { title: 'Environment variables', href: '/discord-mcp/reference/config/', description: '23+ env vars driving the server: token, logging, telemetry, retry/timeout, circuit/bulkhead, audit. Defaults and ranges sourced from the Zod schema.' },
    ...
    { title: 'Changelog', href: '/discord-mcp/reference/changelog/', description: 'One section per release v0.0.0 → v0.13.0. Highlights, dates, links to merge commits.' },
  ]}
/>
