...
description: Full reference for the 27 environment variables that drive discord-mcp at runtime — token, safety, logging, gateway, telemetry, retry/timeout, circuit/bulkhead, audit.
sidebar:
  order: 2
---
...
[`packages/mcp-core/src/config.ts`](https://github.com/cappylab/discord-mcp/blob/main/packages/mcp-core/src/config.ts).
