...
description: Configure credentials, a default guild, the tool-category allowlist, and progressive tool discovery.
---
...
by `MCP_CATEGORIES`, and every dispatched call still passes validation,
category, confirmation, dry-run, audit, and resilience middleware. Keep
`MCP_CATEGORIES` narrow even when progressive discovery is enabled.
