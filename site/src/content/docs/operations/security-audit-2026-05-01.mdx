...
<Aside type="caution" title="Historical snapshot">
This audit records the repository state on 2026-05-01. It is not a statement of
current coverage or a compliance guarantee. Use [Audit logging](/discord-mcp/operations/audit/)
for the current behavior and limitations.
</Aside>

<Aside type="caution" title="Superseded">
This page is a **point-in-time record** of the codebase at commit `438b679`.
Its findings - including the dependency-audit counts - were accurate on
2026-05-01 and are deliberately left unchanged so the record stays citable.

For the current state, see
[Security audit - 2026-07-27](/discord-mcp/operations/security-audit-2026-07-27/).
</Aside>
