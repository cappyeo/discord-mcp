---
title: Client setup
description: Wire up discord-mcp with Claude Desktop, Claude Code, Codex, Antigravity CLI, Gemini CLI, Cursor, or any generic MCP client.
type: tutorial
sidebar:
  order: 22
prev:
...
profile. The Codex fragment forwards `DISCORD_TOKEN` from the environment. Antigravity CLI and most
