---
title: Client setup
description: Wire up discord-mcp with Claude Desktop, Claude Code, Codex, Antigravity CLI, Cursor Agent CLI, Grok Build CLI, DeepSeek Harness, legacy Gemini CLI, the Cursor editor, or any generic MCP client.
type: tutorial
sidebar:
  order: 22
prev:
...
<ClientTabs>
  ...
  [native Windows](https://cursor.com/docs/cli/installation), verify it with
  ...
  Install and configure [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness)
  ...
  `devbot` profile. See the [official patch configuration guide](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/user/guide/mcp-memory.md).
  ...
  The [MCP plugin](https://github.com/deepseek-ai/deepseek-harness/blob/master/packages/mcp/mcp-client/README.md)
...
The client can show **up to 209 visible direct tools**. `MCP_CATEGORIES` and `ALLOWED_GUILDS`
